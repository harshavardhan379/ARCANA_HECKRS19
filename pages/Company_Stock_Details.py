...
def stock_news(ticker):
    ...
    st.subheader(f"{ticker} Stock News")
    for article in news:
        st.write(f"**{article['title']}**")
        st.write(article['summary'])
        st.write(f"Source: {article['source']} | Published: {article['publishedDate']}")
...
menu = ['Stock Info', 'Stock History', 'Stock Recommendations', 'Stock News', 'Capital Allocation']
